...
<!-- Mirrored from etikto-admin-dashboard.multipurposethemes.com/bs5/main/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 May 2024 04:18:16 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="{{ asset('backend/images/avatar/2.jpg') }}" class="avatar avatar-lg">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img src="{{ asset('backend/images/avatar/3.jpg') }}" class="avatar avatar-lg">
                            </span>
                        </div>
                        <div class="cm-msg-text">
    ...
    <script src="{{ asset('backend/assets/icons/font-awesome/js/fontawesome.min.js') }}"></script>
    ...
    <script src="{{ asset('backend/assets/js/pages/dashboard2.js') }}"></script>
