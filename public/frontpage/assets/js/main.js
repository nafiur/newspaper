    ...
    f &&
        ("dark" === f
            ? (e("html").addClass("dark-theme").attr("data-theme", "dark"),
              e(".theme-switcher").addClass("active"))
            : (e("html").addClass("light-theme").attr("data-theme", "light"),
              e(".theme-switcher").removeClass("active"))),
        e(".theme-toggler, .theme-switcher").on("click", function (t) {
            t.preventDefault(),
                (function () {
                    e("html")
                        .toggleClass("dark-theme")
                        .removeClass("light-theme");
                    const t = e("html").hasClass("dark-theme")
                        ? "dark"
                        : "light";
                    e("html").attr("data-theme", t),
                        e(".theme-switcher").toggleClass("active"),
